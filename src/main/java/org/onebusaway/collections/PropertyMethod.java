...
/**
 * A wrapper interface that provides methods similar to
 * {@link Method#invoke(Object, Object...)} for Java bean property getter
 * methods (aka takes no arguments), but allows us to more easily swap in
...
public interface PropertyMethod {
  ...
  /**
   * Invoke the property method on the specified target object and return the
   * resulting value.
   * 
